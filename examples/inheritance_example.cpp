...
public:
  Vehicle(int seats, int capacity, string brand) : seats_(seats), capacity_(capacity), brand_(std::move(brand))
  {
  }
...
public:
  ...
  string special_brakes() const
  {
    return special_brakes_;
  }
...
public:
  ...
  string stereo_brand() const
  {
    return stereo_brand_;
  }
